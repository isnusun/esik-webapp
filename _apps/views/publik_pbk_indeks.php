              ...
              <i class="fa fa-check-square-o fa-fw"></i> Indikator <i class="fa fa-chevron-down"></i>
				...
				<div class="box-body">
					...
					<table class="table table-responsive table-bordered datatables">
						...
						<tbody>
							<?php
							$toGraph["title"][0] = "Grafik Data Sisiran Rumah Tangga Per Wilayah";
							$toGraph["title"][1] = "Grafik Data Sisiran Individu Per Wilayah";
							$i = 1;
							...
							foreach($data_kelas as $key=>$item) {
								...
								if($item['tingkat'] < 7){
									echo "
									<tr><td><a href=\"".site_url('dlmangka/pbk/indeks/'.$key)."\">".$tingkatan[$item['tingkat']]." ".$item['nama']."</a></td>";
								}else{
									echo "
					...
					<div class="">
						...
						<fieldset class="kotak">
							<legend><strong>Grafik Data Sisiran per Individu </strong><?php echo $wilayah;?></legend>
							<div>
