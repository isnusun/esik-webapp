			...
			<div class="box box-default">
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						<div class="btn-group">
						<a class="btn btn-warning btn-xs" href="<?php echo site_url('dlmangka/pbdt'); ?>">Basis Indikator PBDT 2015</a>
						<a class="btn btn-primary btn-xs" href="<?php echo site_url('dlmangka/pbk'); ?>">Basis Indikator Lokal</a>
						</div>
					</div>
				</div>
								...
								<tbody>
									...
									foreach($skgakin['sub'] as $key=>$item){
										...
										if($skgakin['stingkat'] <7){
											echo "
											<td><a href=\"".site_url('dlmangka/index/'.$key)."\">".$skgakin['stingkatan']." ".$item['nama']."</a></td>
											<td class=\"angka\"><a href=\"".site_url('dlmangka/index/'.$key.'/'.$toPeriode[1])."\">".number_format($item['rt1'],0)."</a></td>
											<td class=\"angka\"><a href=\"".site_url('dlmangka/index/'.$key.'/'.$toPeriode[1])."\">".number_format($item['art1'],0)."</a></td>
											<td class=\"angka\"><a href=\"".site_url('dlmangka/index/'.$key.'/'.$toPeriode[2])."\">".number_format($item['rt2'],0)."</a></td>
											<td class=\"angka\"><a href=\"".site_url('dlmangka/index/'.$key.'/'.$toPeriode[2])."\">".number_format($item['art2'],0)."</a></td>";
										}else{
											echo "
