 ...
 <!-- Content Wrapper. Contains page content -->
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>Verifikasi dan Validasi Data <strong class="text-red">[<?php echo $periode[$periode_q]['nama']?>]</strong>
		...
		<section class="content">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="row">
						<div class="col-md-5 col-sm-12 col-xs-12">
							<div class="box box-primary box-solid">
								<div class="box-header with-border"><h3 class="box-title"><i class="fa fa-user fa-fw"></i> Kepala RTS</h3></div>
								<div class="box-body">

									<dl class="dl-horizontal">
										<?php 
											
											$dtlahir = ($rtm['kepala_dtlahir'] == '0000-00-00') ? "Tidak Terdata" : date("j F Y",strtotime($rtm['kepala_dtlahir'])).",<br />".$rtm['kepala_umur']." tahun";
											echo "
											<dt>NO Urut RT</dt><dd>".$rtm['rtm_no']."</dd>
											<dt>Kepala Rumah Tangga</dt><dd>".$rtm['kepala']."</dd>
											<dt>Jenis Kelamin</dt><dd>".$rtm['kepala_sex']."</dd>
											<dt>Tanggal Lahir, Umur</dt><dd>".$dtlahir."</dd>

											<dt>Anggota Rumah Tangga</dt><dd><a href=\"#list_art\">".count($rtm['anggota'])."</a></dd>
											
											";
										// echo var_dump($rtm);
										$cacah_status = _cacah_status();
										$cacah_pada = ($rtm['cacah_pada'] !="0000-00-00") ? $rtm['cacah_pada']: date('Y-m-d');
										$cacah_color = "has-warning";
										if($rtm['cacah_oleh'] !=""){
											$cacah_color = "has-success";
										}
										?>
									</dl>
									<fieldset class="kotak">
										<legend>Status Hasil Pencacahan Rumah Tangga</legend>
										<div>
											<form action="">
												<div class="form-group <?php echo $cacah_color; ?>">
													<label class="control-label">Nama Pencacah</label>
													<div class="cacah_rts editable form-control" id="rumahtangga_oleh_<?php echo $rtm['rtm_id'];?>">
														<?php echo $rtm['cacah_oleh']; ?>
													</div>
												</div>
												<div class="form-group  <?php echo $cacah_color; ?>">
													<label class="control-label">Tanggal Pencacahan (yyyy-mm-dd)</label>
													<div class="cacah_rts editable form-control" id="rumahtangga_pada_<?php echo $rtm['rtm_id'];?>">
														<?php echo $cacah_pada; ?>
													</div>
												</div>
												<div class="form-group  <?php echo $cacah_color; ?>">
													<label class="control-label">Hasil Pencacahan</label>
													<div class="cacah_rts_status editable form-control" id="rumahtangga_status_<?php echo $rtm['rtm_id'];?>">
														<?php echo $cacah_status[$rtm['cacah_status']]; ?>
													</div>
												</div>
											</form>
										</div>
							...
							<div class="box box-warning box-solid">
								<div class="box-header with-border"><h3 class="box-title"><i class="fa fa-th-list fa-fw"></i> KARTU KELUARGA dlm Rumah Tangga</h3></div>
								<div class="box-body no-padding">
									<div class="callout callout-danger">
										<h4>Perhatian!</h4>
										<p>Pastikan ada salah satu Kartu Keluarga yang menjadi KK Utama</p>
									</div>
									<?php 
									$status_kk_dlm_rts = array(
										"0"=>'KK Anggota RTS',
										"1"=>'KK Utama',
										);
									$sum_art =0 ;
									...
									if($kks_anggota){
										...
										<tbody>";
										$no=1;
										foreach($kks_anggota as $k=>$item){
											$sum_art += $item['narts'];
											
											echo "<tr><td class=\"angka\">".$no."</td>
											<td><a href=\"#kks_".$item['kk_no']."\">".$item['kk_no']."</a></td>
											<td class=\"angka\">".$item['narts']."</td>
											<td>
												<div class=\"btn-group\">
													<button type=\"button\" class=\"btn btn-xs btn-default\">".$status_kk_dlm_rts[$item['rts_utama']]."</button>
													<button type=\"button\" class=\"btn btn-xs btn-default dropdown-toggle\" data-toggle=\"dropdown\">
														<span class=\"caret\"></span>
														<span class=\"sr-only\">Toggle Dropdown</span>
													</button>
													<ul class=\"dropdown-menu\" role=\"menu\">
														<li><a href=\"".site_url('verval/set_rts_utama/'.$rtm['rtm_id'].'/'.$item['rtm_no'].'/'.$item['id'].'/1')."\">Atur sbg KK Utama dlm RTS</a></li>
														<li><a href=\"".site_url('verval/set_rts_utama/'.$rtm['rtm_id'].'/'.$item['rtm_no'].'/'.$item['id'].'/0')."\">Atur sbg KK Anggota RTS</a></li>
														<li class=\"divider\"></li>
														<li><a name=\"".$item['kk_no']."\" id=\"".$item['rtm_no']."\" rel=\"".site_url('verval/set_rts_out/'.$item['kk_no'].'/'.$item['rtm_no'].'/'.$item['id'].'/0')."\" class=\"remkk\" data-toggle=\"modal\" data-target=\"#myModal\">Keluarkan dari Anggota RTS</a></li>
													</ul>
												</div>
											</td>
											</tr>";
										...
										echo "</tbody>
										<tfoot>
											<tr><th colspan=\"2\" class=\"angka\">JUMLAH</th><th class=\"angka\">".$sum_art."</th></tr>
										</tfoot>
										</table>
								...
								<div class="box-footer"><p class="help-blok">* Jumlah anggota rumah tangga yg sdh di validasi ke dukcapil</p></div>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-12 col-xs-12">
							...
							<div class="box box-primary box-solid">
								...
								<div class="box-footer">
									<input type="hidden" name="rts_no_rtm" value="<?php echo $rtm['rtm_no']; ?>"/>
									<input type="hidden" name="rts_id_rtm" value="<?php echo $rtm['rtm_id']; ?>"/>
						...
						<div class="col-md-4 col-sm-12 col-xs-12">
							<!-- form #1-->
							<div class="box box-primary box-solid">
								<div class="box-header with-border"><h3 class="box-title"><i class="fa fa-refresh fa-fw"></i> Sinkronisasi ke Dukcapil</h3></div>
								<div class="box-body">
									...
									if($rtm['baru']){
										echo "
										<div class=\"callout callout-danger\">
											<h4>Rumah Tangga Sasaran Baru</h4>
											<p>Silakan tambahakan data Kartu Keluarga baru, sebelum dilanjutkan sinkronisasi dukcapil</p>
										</div>
											<a class=\"btn btn-app\" href=\"".site_url('tools/sync2capil/'.$rtm['rtm_no'])."\"><i class=\"fa fa-refresh\"></i> Sinkronisasi ke DUKCAPIL</a>
									...
									<div>
										<h4>Sinkronisasi</h4>
										<p>Proses sinkroniasi data dengan DUKCAPIL menggunakan sistem online, dengan menyampaikan nomor KK yang terdaftar di daftar KK dalam rumah tangga ini.</p>
										<p>Bila terjadi kasus data <strong class="color-red">TIDAK TERDAFTAR DI DUKCAPIL</strong> silakan pastikan bahwa, 
										nomor KK terisi dengan benar.</p>
										<p>Bila nomor KK didaftar tidak terisi dengan benar, silakan lakukan langkah berikut:</p>
										<ol>
											<li>Periksa Nomor KK dengan menggunakna formulir <a href="#merge-kk">Form Menambahkan KK dalam Rumah Tangga</a>, bila ditemukan, silakan dilanjut prosesnya.</li>
											<li>Bila langkah diatas tidak menampilkan data Nomor KK yang dimaksud, silakan gunakan formulir 
											<a href="#kk_baru">Form Mendaftarkan KK BARU ke Rumah Tangga</a> untuk mendaftarkan nomor KK tersebut ke Rumah Tangga ini</li>
										</ol>
									</div>
					...
					<div class="box box-warning box-solid">
						<div class="box-header with-border"><h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i> PENAMBAHAN KARTU KELUARGA dlm Rumah Tangga</h3></div>
						<div class="box-body">
							<div class="row">
								<div class="col-md-6 col-sm-12 col-xs-12">
									...
									if(!$rtm['baru']){
										?>
										<fieldset class="kotak">
										<legend id="merge-kk">Form Menambahkan KK dalam Rumah Tangga</legend>
										<p class="help-block">Silakan cari dari daftar Kartu Keluarga yang sdh tersimpan dalam sistem menggunakan formulir ini</p>
										<form action="<?php echo $form_add_kk2rtm?>" method="POST" class="formular">
											<div id="detail_cari">
												<div class="form-group">
													<label class="label-control">NOMOR KARTU KELUARGA</label>
													<input type="text" name="addnokk" id="addnokk" class="form-control" /> 
												</div>
											</div>
											...
											<div id="detail_rtm" class="form-group hidden">
												<dl class="dl-horizontal">
													...
													<dt>Nama Kepala Rumah Tangga</dt>
														<dd id="rtm_kepala"></dd>
													<dt>Alamat Kartu Keluarga</dt>
														<dd id="rtm_alamat"></dd>
												</dl>
												<input type="hidden" name="datane" id="datane" value=""/>
												<input type="hidden" name="rtm_no" id="datane_rtm_no" value="<?php echo $rtm['rtm_no']; ?>"/>
											</div>
											<div class="form-group">
												<button class="btn btn-primary btn-sm" type="submit"><i class="fa fa-plus fa-fw"></i> Tambah Data Kartu Keluarga</button>
												<button class="btn btn-default btn-sm" type="reset" id="reset"><i class="fa fa-refresh fa-fw"></i> Reset</button>
											</div>
										</form>
										</fieldset>
									<?php 
								...
								<div class="col-md-6 col-sm-12 col-xs-12">
									<fieldset class="kotak" id="kk_baru">
									<legend>Form Mendaftarkan KK BARU ke Rumah Tangga</legend>
									<p class="help-block">Bila pencarian tidak membuahkan hasil, berarti Kartu Keluarga belum terdaftar, silakan tuliskan NOMOR Kartu Keluarga ke dalam formulir ini</p>
									<form action="<?php echo $form_add_newkk2rtm?>" method="POST" class="formular">
										<div id="detail_cari">
											<div class="form-group">
												<label class="label-control">NOMOR KARTU KELUARGA</label>
												<input type="text" name="addnokk" id="newnokk" class="form-control validate[required]" /> 
											</div>
										</div>
										<div class="form-group">
											<input type="hidden" name="rtm_no" id="datane_rtm_no" value="<?php echo $rtm['rtm_no']; ?>"/>
											<button class="btn btn-primary btn-sm" type="submit"><i class="fa fa-plus fa-fw"></i> Daftarkan Kartu Keluarga</button>
										</div>
									</form>
									</fieldset>
								</div>
...
$(document).ready(function() {
	 ...
	 * Jeditable
	 */
	var ehr = $('.editable_hub_rtm');
	$(ehr).editable('<?php echo site_url('verval/simpan_idv_hubrts');?>',{
		data : '<?php print  json_encode($RTSHub);?>',
		type : 'select',
		...
		callback : function(value, settings) {
			$('#btn_').html('<button class="btn btn-success btn-xs"><i class="fa fa-check"></i></button>');
			console.log(this);
			console.log(value);
	...
	var idvn = $('.editable_idv');
	$(idvn).editable('<?php echo site_url('verval/simpan_idv_edit');?>',{
		indicator : '<img src="<?php echo base_url('assets/img/ajax-loader.gif');?>">',
		tooltip   : 'Klik untuk mengisi data...',
		submit : 'Simpan'
	});

	var cacah_rts = $('.cacah_rts');
	$(cacah_rts).editable('<?php echo site_url('verval/simpan_rts_cacah');?>',{
		indicator : '<img src="<?php echo base_url('assets/img/ajax-loader.gif');?>">',
		tooltip   : 'Klik untuk mengisi data...',
		submit : 'Simpan'
	});
	...
	var cacah_rts_status = $('.cacah_rts_status');
	$(cacah_rts_status).editable('<?php echo site_url('verval/simpan_rts_cacah');?>',{
		indicator : '<img src="<?php echo base_url('assets/img/ajax-loader.gif');?>">',
		data : '<?php print  json_encode($cacah_status);?>',
		type : 'select',
		tooltip   : 'Klik untuk mengisi data...',
		submit : 'Simpan'
	});
	...
	*/
	...
	if(kel){
		...
		$("#rw_id").depdrop({
			url: '<?php echo site_url('ajax/siteman_wilayah/'.substr($rtm['kode_wilayah'],0,14));?>',
			depends: ['kel_id'],
		...
		function initialize(){
			...
			google.maps.event.addListener(map, 'click', function(event){
				if (event.latLng) {
					...
					var postdata = {'rtm_no':<?php echo $rtm['rtm_no'];?>,
