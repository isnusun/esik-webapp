			...
			?>
					...
					<div class="box box-primary box-solid">
						<div class="box-header with-border">
							<h3 class="box-title"><i class="fa fa-list-ol fa-fw"></i>Pengaturan Indikator dan Skoring Individu / Anggota Rumah Tangga</h3>
						</div>
						<div class="box-body no-padding">
							...
							<table class=\"table table-responsive table-bordered\">
								...
								foreach($param as $key=>$item){
									...
									<td>
										<div class=\"editable editable_gakin\" id=\"gk_param_idv__bobot__".$item['id']."\">".$item['bobot']."</div>
										</td>
									</tr>";
									if($item['jenis'] == 1){
										if(is_array($opsi)){
											if(array_key_exists($item['id'],$opsi)){
												foreach($opsi[$item['id']] as $o=>$rs){
													echo "<tr>
													<td>&nbsp;</td>
													<td class=\"angka\">".$rs['opsi_kode']."</td>
													<td>".$rs['nama']."</td>
													<td></td>
													<td>
														<div class=\"editable editable_gakin\" id=\"gk_param_opsi_idv__bobot__".$rs['id']."\">".$rs['bobot']."</div>
														</td>
													</tr>";
												}
											}
