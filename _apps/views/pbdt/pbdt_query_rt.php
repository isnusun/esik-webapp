...
?>
 <!-- Content Wrapper. Contains page content -->
	...
	<div class="content-wrapper">
		...
		<form action="<?php echo site_url('pbdt/customquery')?>" method="POST" role="form">
							...
							<fieldset class=\"kotak\">
								...
								if($item['jenis'] == 1){
									foreach($opsi[$item['id']] as $o=>$op){
										...
										echo "
										<div class=\"checkbox\">
										<label><input type=\"checkbox\" name=\"".$op_name."[".$o."]\" value=\"".$op['opsi_kode']."\" ".$strC."/>[".$op['opsi_kode']."] ".$op['nama']."</label>
										</div>";
