					...
					if($data){
						...
						foreach($data as $key=>$rs){
							...
							<tr><td class='angka'>".$nomer."</td>
								<td><a href='".site_url('backend/pbdt/art_detail')."/".$rs['idbdt']."'>".$rs['idbdt']."</a></td>
								<td><a href='".site_url('backend/pbdt/art_detail')."/".$key."'>".strtoupper(strtolower($rs['idartbdt']))."</a></td>
								<td><a href='".site_url('backend/pbdt/art_detail')."/".$key."'>".strtoupper(strtolower($rs['nama']))."</a></td>
								<td>".$rs['umur']."</td>
								<td>".$rs['percentile']."</td>
							</tr>";
							$nomer++;
