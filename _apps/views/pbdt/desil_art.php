					...
					if($data){
						...
						foreach($data as $key=>$rs){
							...
							<tr><td class='angka'>".$nomer."</td>
								...
								<td><a href='".site_url('backend/pbdt/art_detail')."/".$rs['idartbdt']."'>".$rs['idartbdt']."</a></td>
								<td><a href='".site_url('backend/pbdt/art_detail')."/".$rs['idartbdt']."'>".strtoupper(strtolower($rs['nama']))."</a></td>
