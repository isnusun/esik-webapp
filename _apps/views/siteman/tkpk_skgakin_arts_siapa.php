 ...
 <!-- Content Wrapper. Contains page content -->
	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			?>
			<div class="box box-primary">
				<div class="box-header with-border"><h3 class="box-title"><?php echo $pageTitle; ?></h3></div>
				<div class="box-body">
		<table class="table table-responsive table-bordered datatables" style="background:#fff;">
			<thead>
			<tr>
				<th>#</th>
				<th>NAMA</th>
				...
				<th>ALAMAT</th>
				<?php
				if(array_key_exists('pspesifik',$datane['cols'])){
					echo "<th>".$datane['cols']['pspesifik']."</th>";
				}
				?>
			</tr></thead>
			<tbody>
				<?php 
					...
					$nomer = 1;
					foreach($datane['data'] as $key=>$item){
						$sex = ($item['sex'] == 1) ? "L":"P";
						echo "<tr><td class=\"angka\">".$nomer."</td>
						<td><a href=\"".site_url('kependudukan/individu/'.$item['id'])."\">".$item["pnama"]."</a></td>
						<td><a href=\"".site_url('kependudukan/individu/'.$item['id'])."\">".$item["pnik"]."</a></td>
						<td><a href=\"".site_url('kependudukan/rtm/'.$item['rtm_no'])."\">".$item["pnokk"]."</a></td>
