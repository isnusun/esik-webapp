										...
										<div id=\"collapse".$k."\" class=\"panel-collapse collapse \">
											<div class=\"box-body\">
												...
												foreach($pbk_param[$k] as $key=>$item){
													echo "<li><a href=\"".site_url('pbdt/indikator_rtm/'.$varKode.'/'.$desil_aktif.'/'.$item['id'].'/'.fixNamaUrl($item['nama']))."\">".$item['nama']."</a></li>";
												}
												echo "
												</ul>
											</div>
					...
					<div class="box box-success">
						...
						<div class="box-body">
							...
							foreach ($indikator_opsi as $key=>$item){
								...
								echo "<li ".$strA."><a href=\"".site_url('pbdt/indikator_rtm/'.$varKode.'/'.$desil_aktif.'/'.$indikator['id'].'/'.$item['id'])."\">".$strI." ".$item['nama']."</a></li>";
							}
							?>
							</ul>
						</div>
					...
					<table class="table table-responsive table-bordered datatables">
						...
						<tbody>
							...
							foreach($responden as $key=>$item){
								...
								<td><a href=\"".site_url('pbdt/rtm_view/'.$item['responden_id'].'/')."\">".$item['responden_id']."</a></td>
								<td><a href=\"".site_url('pbdt/rtm_view/'.$item['responden_id'].'/')."\">".$item['pnama']."</a></td>
								<td><a href=\"".site_url('pbdt/rtm_view/'.$item['responden_id'].'/')."\">".$item['pnik']."</a></td>
								<td>".$item['psex']."</td>
