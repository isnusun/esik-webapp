				...
				<div class="box-body">
					...
					if(is_array($alamat)){
						foreach($alamat as $key=>$item){
							echo "<li><a href=\"".site_url('pbdt/index/'.$item['kode'])."\">".$item['nama']."</a></li>";
						}
					}
					?>
					</ol>
					<table class="table table-responsive table-bordered datatables">
						...
						<tbody>
							...
							foreach($data_kelas as $key=>$item) {
								...
								if($item['tingkat'] < 7){
									echo "
									<tr><td><a href=\"".site_url('pbdt/index/'.$key)."\">".$tingkatan[$item['tingkat']]." ".$item['nama']."</a></td>";
								}else{
									echo "
								...
								foreach($desil as $d=>$ds){
									...
									echo "
									<td class=\"angka\"><a href=\"".site_url('pbdt/individu/'.$key.'/'.$d.'/')."\">".number_format($nilai_idv,0)."</a></td>
									<td class=\"angka\"><a href=\"".site_url('pbdt/rtm/'.$key.'/'.$d.'/')."\">".number_format($nilai_rtm,0)."</a></td>
									";
								}
								echo "
