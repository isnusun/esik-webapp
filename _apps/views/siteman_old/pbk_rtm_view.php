				...
				<div class="box-body" >
					<dl class="dl-horizontal">
						<?php 
							...
							<dt>Klasifikasi Data Sisiran</dt><dd>Prioritas ".$rtm['kelas_pbk']."</dd>
							";
						?>
					</dl>
					<?php
									...
									<tbody>
										...
										foreach($rtm['anggota'] as $a=>$o){
											...
											<tr><td class=\"angka\">".$nomer."</td>
												<td><a href=\"".site_url('backend/pbdt/idv_update/'.$o['id'].'/')."\">".$o['pnama']."</a></td>
												<td>".$o['pnik']."</td>
												<td>".$o['psex']."</td>
												<td>".$o['hubungan']."</td>
												<td>".$o['dtlahir']."</td>
												...
												<td><div class=\"btn-group\">
													<a href=\"".site_url('backend/pbdt/idv_update/'.$o['id'].'/')."\"><i class=\"fa fa-edit\"></i></a>
													</div></td>
											</tr>
											";
											$nomer++;
