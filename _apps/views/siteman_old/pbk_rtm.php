 ...
 <!-- Content Wrapper. Contains page content -->
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
			<?php echo $pageTitle;?>
			<small>Data Lokal/Sisiran</small>
			</h1>
			<ol class="breadcrumb">
			<li><a href="<?php echo site_url('siteman')?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
			<li class="active">Data Lokal/Sisiran</li>
			</ol>
		</section>
		...
		<section class="content">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-newspaper-o fa-fw"></i> Daftar Rumah Tangga di <?php echo $wilayah ." dlm ".$desil[$desil_aktif]['nama']; ?></h3>
				...
				<div class="box-body" >
					...
					if(is_array($alamat)){
						foreach($alamat as $key=>$item){
							echo "<li><a href=\"".site_url('pbk/rtm/'.$item['kode'].'/'.$desil_aktif)."\">".$item['nama']."</a></li>";
						}
					}
					?>
					</ol>
					...
					if($rtm){
						if(count($rtm) > 0){
							...
							foreach($rtm as $key=>$item){
								...
								<td><a href=\"".site_url('pbk/rtm_view/'.$item['rtm_no'])."\">".$item['rtm_no']."</a></td>
								<td><a href=\"".site_url('pbk/rtm_view/'.$item['rtm_no'])."\">".$item["nikkepala"]."</a></td>
								<td><a href=\"".site_url('pbk/rtm_view/'.$item['rtm_no'])."\">".$item["kepala"]."</a></td>
