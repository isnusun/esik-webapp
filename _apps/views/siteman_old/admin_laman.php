				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="box box-info">
						<div class="box-header">
							<h3 class="box-title"><i class="fa fa-info fa-fw"></i> Daftar Halaman Statis</h3>
						</div>
						<div class="box-body">
							<ul>
								<li>Silakan lakukan aktivitas pengelolaan halaman web di <?php echo APP_TITLE;?></li>
							</ul>
							<a href="<?php echo site_url('admin/laman_edit');?>"><i class="fa fa-new"></i> Tulis Laman Baru</a>
						</div>
					</div>
				</div>
			</div>
