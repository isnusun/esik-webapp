		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-right navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="menuItem"><a href="<?php echo site_url('dlmangka/pbdt/'); ?>"><i class="fa fa-line-chart"></i> Kesejahteraan dlm Angka</a></li>
<!--                                        
					<li class="menuItem dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-line-chart"></i> Kesejahteraan Dalam Angka <i class="fa fa-chevron-down"></i></a>
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo site_url('dlmangka/lokal/'); ?>">Basis Indikator Lokal</a></li>
