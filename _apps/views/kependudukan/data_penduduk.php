					...
					echo "
						<table class=\"table table-responsive table-bordered datatables\">
							...
							foreach($dataset as $key=>$rs){
								...
								<tr>
								<td>".$nomer."</td>
								<td><a href=\"".site_url('kependudukan/detail_penduduk/').$rs['id']."\">".$rs['nama']."</a></td>
								<td>".$rs['nik']."</td>
								<td>".$rs['kk_nomor']."</td>
								<td>".$rs['alamat']."</td>
								<td>".$rs['dusun']."</td>
								...
								<a class=\"btn btn-xs btn-default\" title=\"Edit Data\" href=\"".site_url('kependudukan/detail_rts/').$key."/edit\"><i class=\"fa fa-pencil\"></i></a>
								<a class=\"btn btn-xs btn-danger\" title=\"Hapus Data\" href=\"".site_url('kependudukan/detail_rts/').$key."/hapus\"><i class=\"fa fa-trash\"></i></a>
							</div></td>
								</tr>";
							}
							echo "
