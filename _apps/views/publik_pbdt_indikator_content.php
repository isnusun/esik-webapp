				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					...
					foreach($desil as $d=>$des){
						...
						<div class="box box-success">
							<div class="box-header with-border">
								<h3 class="box-title"><a name="<?php echo $d;?>"><?php echo $des[2];?></a> | <small><?php echo $boxTitle; ?></small></h3>
							</div>
							<div class="box-body">
								<!--tabular-->
								...
								<table class="table table-responsive table-bordered datatables">
									...
									<tbody>
										...
										foreach($data_kelas[$d] as $key=>$item) {
											...
											if($item['tingkat'] < 7){
												echo "
												<tr><td><a href=\"".site_url('dlmangka/pbdt/indikator/'.$key.'/'.$indikator['id'].'/'.fixNamaUrl($indikator['nama']))."\">".$tingkatan[$item['tingkat']]." ".$item['nama']."</a></td>";
											}else{
												echo "
									...
									<tfoot>
										<tr><th class="angka">&Sigma; JUMLAH</th>
											...
											foreach($indikator_opsi as $key=>$item){
												echo "
												<th class=\"angka\">".number_format($sumIDV[$key],0)."</th>
												";
											}
											?>
										</tr>
