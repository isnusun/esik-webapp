		...
		<section class="content">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title"><a href="<?php echo site_url('verval');?>">Daftar RTS di Wilayah Administrasi <?php echo $user['wilayah_nama']?></a></h3>
				</div>
									...
									if($sasaran){
										if(count($sasaran) > 0){
											...
											foreach($sasaran as $k=>$rs){
												...
												<td><a href=\"".site_url('verval/form_rts/'.$rs['idbdt'])."\" target=\"_blank\">".$rs['idbdt']."</a></td>
												<td>".$rs['nama_krt']."
													<br />".$rs['alamat']."</td>
										...
										if($sub_wilayah){
											if(count($sub_wilayah) > 0){
												...
												foreach ($sub_wilayah as $key => $wil) {
													...
													<td><a href='".site_url('verval/?kode='.$key)."'>".$wil['nama']."</a></td>
													<td class='angka'>".number_format($wil['sum_rts'],0)."</td>
													</tr>";
													$sum_rts += $wil['sum_rts'];
													$nomer++;
												}
												...
												<tfoot><tr><th>#</th><th class='angka'>JUMLAH</th><th>".$sum_rts."</th></tr>
												</tfoot>
												</table>";
