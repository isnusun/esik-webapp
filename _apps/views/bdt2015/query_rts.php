		...
		<section class="content">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Query Data Rumah Tangga PBDT 2015</a></h3>
				...
				<div class="box-body">
					...
					<form action="<?php echo site_url('backend/bdt2015/query_rts'); ?>" method="POST" role="form" class="formular">
					...
					if($_REQUEST){
						...
						<fieldset class=\"kotak\">
							...
							foreach($indikator_aktif as $p){
								// $op_name = str_replace('  min','',$p);
								// $op_name = str_replace('  max','',$op_name);
						...
						if($dataset){
							...
							<h4>Telah ditemukan Data sebanyak <strong>".$dataset['numrows']."</strong> Rumah Tangga Sasaran</h4>
							</div>";
							echo "							
							...
							foreach($dataset['data'] as $key=>$rs){
								...
								<td><a href='".site_url('backend/bdt2015/rts_detail/').$rs['Nomor Urut Rumah Tangga']."'>".$rs['Nama Kepala Rumah Tangga']."</a></td>
							...
							if($paging['page_total']> 1){
								...
								if($paging['page_prev'] > 1){
									echo "<li><a href='".site_url('backend/bdt2015/query_rts/?param='.$query_string)."&amp;p=1'><i class='fa fa-fast-backward'></i></a></li>
									<li><a href='".site_url('backend/bdt2015/query_rts/?param='.$query_string)."&amp;p=".$paging['page_prev']."'><i class='fa fa-backward'></i></a></li>";
								}
								...
								for($i=$apage;$i<$epage;$i++){
									echo "<li><a href='".site_url('backend/bdt2015/query_rts/?param='.$query_string)."&amp;p=".$i."'>".$i."</a></li>";
								}

								if($paging['page_next'] < $paging['page_total']){
									echo "<li><a href='".site_url('backend/bdt2015/query_rts/?param='.$query_string)."&amp;p=".$paging['page_next']."'><i class='fa fa-forward'></i></a></li>
									<li><a href='".site_url('backend/bdt2015/query_rts/?param='.$query_string)."&amp;p=".$paging['page_total']."'><i class='fa fa-fast-forward'></i></a></li>";
								}else{
									echo "<li><a href='".site_url('backend/bdt2015/query_rts/?param='.$query_string)."&amp;p=".$paging['page_total']."'><i class='fa fa-fast-forward'></i></a></li>";
								}
								echo "</ul></div>";
							}							
						}else{
