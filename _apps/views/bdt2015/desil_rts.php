					...
					if($data){
						...
						foreach($data as $key=>$rs){
							...
							<tr><td class='angka'>".$nomer."</td>
								<td><a href='".site_url('backend/bdt2015/rts_detail')."/".$key."'>".$key."</a></td>
								<td><a href='".site_url('backend/bdt2015/rts_detail')."/".$key."'>".strtoupper(strtolower($rs['Nama Kepala Rumah Tangga']))."</a></td>
								<td>".$rt."</td><td>".$rw."</td>
